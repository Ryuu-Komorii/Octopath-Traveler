...
public class Tests
{
    ...
    [Theory]
    [MemberData(nameof(GetTestsAssociatedWithThisFolder), parameters: "E4-AdvancedSkills")]
    public void TestE4_AdvancedSkills(string teamsFolder, string testFile)
        => RunTest(teamsFolder, testFile);
    
    [Theory]
    [MemberData(nameof(GetTestsAssociatedWithThisFolder), parameters: "E4-SkillBoosting")]
    public void TestE4_SkillBoosting(string teamsFolder, string testFile)
        => RunTest(teamsFolder, testFile);
    
    [Theory]
    [MemberData(nameof(GetTestsAssociatedWithThisFolder), parameters: "E4-DivineSkills")]
    public void TestE4_DivineSkills(string teamsFolder, string testFile)
        => RunTest(teamsFolder, testFile);
    
    [Theory]
    [MemberData(nameof(GetTestsAssociatedWithThisFolder), parameters: "E4-PassiveSkills")]
    public void TestE4_PassiveSkills(string teamsFolder, string testFile)
        => RunTest(teamsFolder, testFile);
    
    [Theory]
    [MemberData(nameof(GetTestsAssociatedWithThisFolder), parameters: "E4-Mix")]
    public void TestE4_Mix(string teamsFolder, string testFile)
        => RunTest(teamsFolder, testFile);
